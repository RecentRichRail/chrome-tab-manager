          ...
          for (const [winId, grpMap] of winMap.entries()) {
            ...
            for (const [gid, tabs] of grpMap.entries()) {
              ...
              for (const tab of tabs) {
                ...
                const escapedTabUrl = escapeHtml(tab.url || '');
                ...
                tEl.innerHTML = `
                  <div style="flex:1;min-width:0;display:flex;flex-direction:column;justify-content:center;">
                    ...
                    <div style="font-size:11px;color:var(--muted);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;margin-top:2px;" title="${escapedTabUrl}">${escapedTabUrl}</div>
                  </div>
